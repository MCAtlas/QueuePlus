...
import io.mcatlas.queueplus.object.Weighted;
...
public class SubQueue extends Weighted {
    ...
    public void addPlayer(@NotNull QueuedPlayer player) {
        Main.debug("Added player " + player.name() + " to subqueue " + this.name);
        players.add(player);
    }

    public void addPlayer(@NotNull QueuedPlayer player, int index) {
        Main.debug("Added player " + player.name() + " to subqueue " + this.name + " at position " + index);
        players.add(index, player);
    }

    public void removePlayer(@NotNull QueuedPlayer player) {
        Main.debug("Removed player " + player.name() + " from subqueue " + this.name);
        players.remove(player);
    }

    public QueuedPlayer removePlayer(int index) {
        Main.debug("Removed player at position " + index + " from subqueue " + this.name);
